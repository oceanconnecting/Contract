export const heroSectionContent = {
  ...
  joinText3:
    " et commencez à réaliser vos rêves et vos désirs avec OceanConnecting",
  buttons: [
    {
      text: "Contact US",
      link: "/contract",
      className:
        "inline-flex items-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-gradient-to-r from-blue-600 to-red-600 border rounded-xl font-pj hover:bg-gray-600 hover:to-red-500 transform hover:scale-105",
    },
    {
      text: "Télécharger le formulaire",
      link: "/contract",
      className:
        "inline-flex items-center px-4 py-4 text-lg font-bold transition-all duration-200 bg-transparent border rounded-xl hover:bg-gradient-to-r from-blue-600 to-red-600 hover:text-white hover:to-red-500 transform hover:scale-105",
      icon: {
        svgPath:
...
export const contractContent = {
  ...
  description:
    "Trouvez des opportunités d'emploi en Europe avec OceanConnecting. Nous facilitons l'accès aux marchés du travail européens et aidons à obtenir les contrats et documents nécessaires. Rejoignez-nous pour démarrer facilement votre carrière en Europe.",
  button: "To Apply",
  contracts: [
    {
      id: 1,
      ...
      country: "Croatie",
      sector:
        "Construction / Forge / Menuiserie / Peinture / Mécanique électrique / Climatisation / Permis de conduire D / Boucherie / Hôtellerie",
      ...
      additionalInfo:
        "Logement, soins médicaux, renouvelables pour 5 ans, et aide à la citoyenneté.",
