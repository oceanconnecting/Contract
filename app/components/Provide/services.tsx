  ...
  const services = [
    {
      ...
      borderColor: "group-hover:border-gradient-to-r from-blue-600 to-red-60 dark:group-hover:border-blue-700",
      iconBg: "bg-gradient-to-r from-blue-600 to-white dark:bg-blue-900/30",
      iconBorder: "border-gradient-to-r from-blue-600 to-red-60 dark:border-blue-800",
    },
    {
      icon: icon2,
      ...
      description:"",
       area: "md:[grid-area:2/1/3/7] xl:[grid-area:1/5/3/8]",
        ...
        borderColor: "group-hover:border-gradient-to-r from-red-300 to-white dark:group-hover:border-red-700",
        iconBg: "bg-gradient-to-r from-reed-100 to-white dark:bg-red-900/30",
      ...
      borderColor: "group-hover:border-gradient-to-r from-green-300 to-white dark:group-hover:border-green-700",
      iconBg: "bg-gradient-to-r from-green-300 to-white dark:bg-green-200/30",
    ...
    },
    {
      ...
      borderColor: "group-hover:border-gradient-to-r from-yellow-300 to-white dark:group-hover:border-yellow-700",
      iconBg: "bg-gradient-to-r from-yellow-300 to-white dark:bg-yellow-200/30",
    ...
    },
    {
      ...
      borderColor: "group-hover:border-gradient-to-r from-purple-400 to-white dark:group-hover:border-rose-700",
      iconBg: "bg-gradient-to-r from-purple-400 to-white  dark:bg-purple-400 ",
